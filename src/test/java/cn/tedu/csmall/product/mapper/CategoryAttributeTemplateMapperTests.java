...
public class CategoryAttributeTemplateMapperTests {
    ...
    void testInsert() {
        ...
        data.setAttributeTemplateId(1L);
    ...
    void testInsertBatch() {
        List<CategoryAttributeTemplate> list = new ArrayList();
        for (int i = 1; i <= 10; i++) {
            CategoryAttributeTemplate item = new CategoryAttributeTemplate();
            item.setCategoryId(i + 0L);
            item.setAttributeTemplateId(i + 0L);
            list.add(item);
        }
